...
const footerContentController = require('../../controllers/adminControllers/footerContentController');

// Footer Content
router.route('/footer')
  .get(footerContentController.getFooterContent)
  .put(footerContentController.updateFooterContent);
